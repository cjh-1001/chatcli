...
ANALYSIS_ROLES: dict[str, dict[str, Any]] = {
    ...
    "correlator": {
        ...
        "prompt": (
            ...
            ".chatcli/children/ for their records) and produce a unified report.\n\n"
            "Your job:\n"
            ...
            "3. Fill gaps: did any observer miss something? Note it.\n"
            "4. Build attack chain: use attack_chain_builder to sequence events.\n"
            "5. Complete behavior coverage matrix: confirm all dimensions checked.\n"
            "6. Extract final IOCs: network + host + behavioral, all quality-rated.\n"
            "7. Assign ATT&CK techniques: map confirmed behaviors to techniques.\n"
            "8. Produce impact assessment and detection recommendations.\n\n"
            "Output format:\n"
            "## Unified Analysis Report\n"
            "### Executive Summary\n"
            "### Attack Chain\n"
